            ...
            @csrf
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('shop_name') is-invalid @enderror"
                        value="{{ old('shop_name', $shop->shop_name) }}" placeholder="Enter shop name" aria-describedby="emailHelp"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('shop_number') is-invalid @enderror"
                        value="{{ old('shop_number', $shop->shop_number) }}" placeholder="Enter shop number" id="shop_name"
                        name="shop_number">
                    @error('shop_number')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('shop_address') is-invalid @enderror"
                        value="{{ old('shop_address', $shop->shop_address) }}" placeholder="Enter shop address" id="shop_address"
                        name="shop_address">
                    @error('shop_address')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="phone" class="form-control @error('shop_phone') is-invalid @enderror"
                        value="{{ old('shop_phone', $shop->shop_phone) }}" placeholder="Enter shop phone" id="shop_phone"
                        name="shop_phone">
                    @error('shop_phone')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control @error('shop_email') is-invalid @enderror"
                        value="{{ old('shop_email', $shop->shop_email) }}" placeholder="Enter shop email" id="shop_email"
                        name="shop_email">
                    @error('shop_email')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
